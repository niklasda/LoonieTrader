...
public static class Environments
{
    ...
    private static KeyValuePair<string, string> PracticeStreaming { get; } = new KeyValuePair<string, string>("PracticeStreaming", "stream-fxpractice");
    private static KeyValuePair<string, string> LiveStreaming { get; } = new KeyValuePair<string, string>("LiveStreaming", "stream-fxtrade");
